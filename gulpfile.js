...
var gulp = require('gulp');  // use gulp functionality
...
var uglify = require('gulp-uglify');    // minifies JS files; removes al white space to reduce file size
...
gulp.task('reloadCSS', function () {
    return gulp.src('./public/style.css').pipe(livereload());   // run a command on this directory
});
